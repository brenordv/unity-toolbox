...
- Replaced deprecated `FindObjectOfType` with `FindAnyObjectByType` in TypedAudioClipEditor.

### Fixed
- BaseSingletonController now resets on domain reload, fixing Enter Play Mode Options with domain reload disabled.
